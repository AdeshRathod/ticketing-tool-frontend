...
const AuthInputFiled = ({
              ...
              >
                ...
                {name === "isChecked" && (
                  <Link
                    ...
                    className="font-semibold text-[#000000] hover:underline text-md  "
                  >
  ...
  if (type === "Password1") {
    return (
      <div className="space-y-1 min-w-11 mt-1.5">
        <label
          htmlFor={name}
          className={`${error ? "text-red-500" : "text-gray-500"} font-semibold text-md`}
            ...
            <div
              ...
              className={`${
                focusedInput === name
                  ? "outline-blue-500 outline-3 border-blue-500 border-[2px]"
                  : "outline-none border-gray-200 border-[.5px]"
              } flex items-center px-3 bg-gray-100 py-3 rounded-lg`}
            >
              <input
                ...
                value={field.value}
                placeholder={placeholder}
                className="w-full bg-transparent outline-none text-gray-500 text-md"
                autoComplete={autoComplete ?? "on"}
                {...field}
                formNoValidate
              />
  ...
  return (
    <div className="space-y-2 w-full mt-1.5">
      {label && (
        <label htmlFor={name} className="font-semibold text-gray-500 text-md">
          {label}
        </label>
      )}
      <Controller
        ...
        name={name}
        render={({ field }) => (
          <div className="flex items-center px-4 bg-gray-100 rounded-md py-3 space-x-3">
